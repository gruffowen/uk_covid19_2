...
First load the necessary packages (these contain the functions we will use) and the data. 
...
First we load the data from Public Health Wales. Then tell the computer to treat 'Specimen.date' as a date. 
